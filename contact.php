...
<?php include'header.php';?>
  ...
  <div class="mapouter" style="align-content: center">
                    <div class="gmap_canvas"><iframe width="100%" height="445" id="gmap_canvas" src="https://maps.google.com/maps?q=Primefort&t=&z=15&ie=UTF8&iwloc=&output=embed" frameborder="0" scrolling="no" marginheight="0" marginwidth="0"></iframe><a href=" ">wordpress themes by crocothemes.net</a></div>
                    <style>.mapouter{text-align:center;height:445px;width:100%;}.gmap_canvas {overflow:hidden;background:none!important;height:445px;width:100%;}</style>
                </div>
  <!-- Map START -->
