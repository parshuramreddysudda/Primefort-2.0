      ...
      <div class="row">
        <div class="col-md-4 col-sm-4 col-12">
          <div class="team-single-img">
            <img src="images/team/parshuram.jpg" alt="img">
          </div>
        </div>
        ...
        <div class="col-md-8 col-sm-8 col-12">
          <div class="team-single-text">
            ...
            <div class="text-content mt-20">
              <p>Parshuram Reddy is a 20 years UnderGraduate Student Passionate about Cybersecurity | Makewebsites for living | Active Frontend Developer | takes caffeine with PHP, C, JS, C++, Java. | Loves to sing and groove </p>
            </div>

            <ul class="team-single-social">
              <li><a href="https://www.facebook.com/192.168.0.a"><i class="fa fa-facebook-square"></i></a></li>
              <li><a href="https://twitter.com/ParhuRamreDdyS"><i class="fa fa-twitter"></i></a></li>
              <li><a href="https://www.linkedin.com/in/parshuramreddy/"><i class="fa fa-linkedin"></i></a></li>
            </ul>
          </div>
        </div>
        <!-- Personal Info END -->
